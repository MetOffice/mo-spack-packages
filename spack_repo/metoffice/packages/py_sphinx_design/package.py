...
class PySphinxDesign(PythonPackage):
    ...
    version(
        "0.7.0",
        sha256="d2a3f5b19c24b916adb52f97c5f00efab4009ca337812001109084a740ec9b7a",
    )
    version(
        "0.6.1",
    ...
    version(
        "0.4.1",
        sha256="5b6418ba4a2dc3d83592ea0ff61a52a891fe72195a4c3a18b2fa1c7668ce4708",
    )
    version(
        "0.4.0",
        sha256="b92948614900967499617d99aadd38ce5975ede924a18c7478cc6b8ec188f76b",
    )
    version(
        "0.3.0",
    ...
    depends_on("py-sphinx@7:", when="@0.7.0:", type=("build", "run"))
